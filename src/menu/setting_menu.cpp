...
namespace big
{
    ...
    void setting_menu::render_submenu()
    {
        ...
        {
            sub->add_option<number_option<std::uint8_t>>("Background R", nullptr, &g_ui_manager->m_footer_background_color.r, '\0', static_cast<std::uint8_t>(255));
            sub->add_option<number_option<std::uint8_t>>("Background G", nullptr, &g_ui_manager->m_footer_background_color.g, '\0', static_cast<std::uint8_t>(255));
            sub->add_option<number_option<std::uint8_t>>("Background B", nullptr, &g_ui_manager->m_footer_background_color.b, '\0', static_cast<std::uint8_t>(255));
            sub->add_option<number_option<std::uint8_t>>("Background A", nullptr, &g_ui_manager->m_footer_background_color.a, '\0', static_cast<std::uint8_t>(255));
        });
